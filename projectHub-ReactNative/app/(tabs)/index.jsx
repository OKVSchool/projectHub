...
const styles = StyleSheet.create({
  ...
  fab: { position: 'absolute', bottom: 24, right: 24, backgroundColor: '#7c6cfa', width: 56, height: 56, borderRadius: 28, alignItems: 'center', justifyContent: 'center', elevation: 4 },
